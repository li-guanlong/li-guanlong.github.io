$(function() {
  ...
  $(".gl_cont .slideBar .num").on("click", function() {
    $('.gl_cont .slideBar ul').toggleClass('hide');
    $(".gl_cont .slideBar").toggleClass('current');
  })
...
$(function() {
  // 点击移动
  $(".detail_cont2 .tableBar div").on("click", function () {
		$(this).addClass("current").siblings().removeClass("current");
    var h1 = $(".detail_cont2 .hiddenBox").offset().top;
    var h2 = $(".detail_cont3").offset().top;
    var h3 = $(".detail_cont5").offset().top;
    var h4 = $(".detail_cont6").offset().top;
    var h5 = $(".detail_cont8").offset().top;
    if ($(this).hasClass("intro")) {
        $("html,body").scrollTop(h1-10)
    } else if ($(this).hasClass("config")) {
        $("html,body").scrollTop(h2-10)
    } else if ($(this).hasClass("method")) {
        $("html,body").scrollTop(h3-10)
    } else if ($(this).hasClass("video")) {
        $("html,body").scrollTop(h4-10)
    } else if ($(this).hasClass("commonend")) {
      $("html,body").scrollTop(h5-10)
  }
  });

  $(".detail_cont3 .tabBar div").on("click", function() {
		$(this).addClass("current").siblings().removeClass("current");
		let index = $(this).index();
		$(".detail_cont3 .cont>div").eq(index).removeClass("hide").siblings().addClass("hide");
  });
})

// 图片点击放大
$(function() {
	$('#newmain').find('img').on('click',function(){
			var pswpElement = document.querySelectorAll('.pswp')[0];
			var items = new Array();
			$.each($("#newmain img"), function(i, v) {
					$(v).attr("rel", i);
					items.push({
							src: $(v).attr("src"),
							w: $(v).width(),
  ...
  $(document).on('click', ".show_img .Qimgs img" , function () {
